...
O MultiChat é uma empresa distribuidora de White Label que possui uma solução de atendimentos via Whatsapp que aumenta a produtividade e organização das equipes

## 🚀 Começando

O repositório do MultiChat possui 3 pastas importantes:
- backend
- frontend
- instalador
...
- [Instalador](https://github.com/MultiChat-org/instalador)
...
⌨️ com ❤️ por [MultiChat](https://MultiChat.com) 😊

Todos os direitos reservados a https://MultiChat.com
